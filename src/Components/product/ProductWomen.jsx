...
export default function ProductWomen() {
        ...
        const fetchproductWomen = async () => {
            try {
                ...
                const response = await fetch(
                    'https://localhost:7278/api/Product/ByCategory/2', 
                    { 
                ...
                setProductWomen(Array.isArray(data) ? 
                data.map((p) => 
                    ({
                        ...p,
                        id: p.productID, 
    ...
    <section className="hero-section position-relative text-white">
        <div
          ...
          style={{
            backgroundImage:
              "url('/assets/productwomenimage.png')",
        ...
        >
          ...
          <div className="hero-content position-absolute top-50 start-0 translate-middle-y w-100 ps-5">
            <div className="container">
              <h1 className="display-3 fw-bold mb-4">Empower Your Look</h1>
              <p className="lead mb-5">
              Chic and contemporary outfits for confident women who love to shine
              </p>
              <a
                href="#kid-section"
