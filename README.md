...
> You don't have to ever use eject. The curated feature set is suitable for **small and medium deployments**, and you shouldn't feel obligated to use this feature. However, this tool is useful when you need **full customization**.
...
This section has moved here: [Making a PWA](https://facebook.github.io/create-react-app/docs/making-a-progressive-web-app)
